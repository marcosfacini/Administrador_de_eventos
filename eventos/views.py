...
def gerar_certificado(request, id):
    ...
    path_template = os.path.join(settings.BASE_DIR, 'eventos_admin/templates/static/evento/img/template_certificado.png')
    path_fonte = os.path.join(settings.BASE_DIR, 'eventos_admin/templates/static/fontes/arimo.ttf')
